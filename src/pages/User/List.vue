    ...
    <div class="page-header">
      ...
      <div class="box-actions">
        ...
        <div class="filter" :class="{ active: showFilters }">
          <a
            class="bt bt-square bg-white-2 c-primay"
          ...
          >
            ...
            >
              <path
                d="M23.8975 0.66381C24.0904 1.12904 24.011 1.5262 23.6592 1.85526L15.268 10.2465V22.8759C15.268 23.3525 15.0467 23.6872 14.6042 23.8801C14.4567 23.9369 14.3148 23.9652 14.1787 23.9652C13.8723 23.9652 13.617 23.8575 13.4127 23.6419L9.05541 19.2845C8.83981 19.0689 8.73201 18.8136 8.73201 18.5186V10.2465L0.34077 1.85526C-0.0109926 1.5262 -0.0904229 1.12904 0.102479 0.66381C0.295381 0.22127 0.630123 0 1.10671 0H22.8933C23.3699 0 23.7046 0.22127 23.8975 0.66381Z"
                fill="#41B0CE"
              />
            </svg>
          </a>
        ...
        <base-link to="/users/new" class="bt bt-square bg-white-2 c-primay">
          ...
          >
            <path
              d="M22.5 9H15V1.5C15 0.675 14.325 0 13.5 0H10.5C9.675 0 9 0.675 9 1.5V9H1.5C0.675 9 0 9.675 0 10.5V13.5C0 14.325 0.675 15 1.5 15H9V22.5C9 23.325 9.675 24 10.5 24H13.5C14.325 24 15 23.325 15 22.5V15H22.5C23.325 15 24 14.325 24 13.5V10.5C24 9.675 23.325 9 22.5 9Z"
              fill="#41B0CE"
            />
          </svg>
        </base-link>
          ...
          <tr v-for="item in tableData" :key="item.id">
            ...
            <td class="actions">
              <button
                ...
                class="bt"
                :class="{ 'c-green': item.active, 'c-dark-gray': !item.active }"
              >
                <svg
                  width="24"
                  height="24"
                ...
                >
                  ...
                  />
                  <path
                    d="M16.7609 9.44996L10.8087 15.4021C10.7563 15.4546 10.6714 15.4546 10.6191 15.4021L7.23942 12.0224C7.18712 11.9702 7.18712 11.8853 7.23942 11.8329L8.06063 11.0117C8.11306 10.9594 8.19795 10.9594 8.25026 11.0117L10.714 13.4753L15.7502 8.43913C15.8027 8.38683 15.8874 8.38683 15.9398 8.43913L16.7609 9.26034C16.8133 9.31265 16.8133 9.39741 16.7609 9.44996Z"
                    fill="white"
                  />
                </svg>
              </button>
              ...
              >
                ...
                >
                  <g clip-path="url(#clip0)">
                    <path
                      d="M15.3106 8.69531C15.0001 8.69531 14.7485 8.94692 14.7485 9.25737V19.8803C14.7485 20.1905 15.0001 20.4424 15.3106 20.4424C15.621 20.4424 15.8727 20.1905 15.8727 19.8803V9.25737C15.8727 8.94692 15.621 8.69531 15.3106 8.69531Z"
                      fill="#EB5757"
                    />
                    <path
                      d="M8.67803 8.69531C8.36758 8.69531 8.11597 8.94692 8.11597 9.25737V19.8803C8.11597 20.1905 8.36758 20.4424 8.67803 20.4424C8.98848 20.4424 9.24009 20.1905 9.24009 19.8803V9.25737C9.24009 8.94692 8.98848 8.69531 8.67803 8.69531Z"
                      fill="#EB5757"
                    />
                    <path
                    ...
                    />
                    <path
                      d="M11.9944 8.69531C11.684 8.69531 11.4324 8.94692 11.4324 9.25737V19.8803C11.4324 20.1905 11.684 20.4424 11.9944 20.4424C12.3049 20.4424 12.5565 20.1905 12.5565 19.8803V9.25737C12.5565 8.94692 12.3049 8.69531 11.9944 8.69531Z"
                      fill="#EB5757"
                    />
                  </g>
                  <defs>
