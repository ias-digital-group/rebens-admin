      ...
      <el-tabs>
        <el-tab-pane label="Cadastro">
          <form class="form-horizontal" v-loading="formLoading" @submit.prevent>
            ...
            <div class="row">
              ...
              <div class="col-md-9 offset-md-3 offset-lg-0 col-lg-3">
                <base-input label="Preço Original">
                  <money class="form-control" v-model="model.originalPrice" v-bind="money"></money>
                </base-input>
                <label v-show="customErros.includes('originalPrice')" class="text-danger">O campo Preço original é obrigatório!</label>
              </div>
              <div class="col-md-9 col-lg-3">
                <base-input label="Desconto">
                  <money class="form-control" v-model="model.discount" v-bind="percentage"></money>
                </base-input>
                <label v-show="customErros.includes('discount')" class="text-danger">O campo Desconto é obrigatório!</label>
              </div>
              <div class="col-md-9 col-lg-3">
                <base-input label="Preço Final">
                  <money class="form-control" v-model="model.finalPrice" v-bind="money"></money>
                </base-input>
                <label v-show="customErros.includes('finalPrice')" class="text-danger">O campo Preço Final é obrigatório!</label>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-9">
                ...
                <label v-show="customErros.includes('duration')" class="text-danger">O campo Duração é obrigatório!</label>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-12">
                <base-link class="btn mt-3 btn-simple btn-primary" to="/course">Voltar</base-link>
                <base-button 
        ...
        <el-tab-pane label="Endereços" :disabled="viewAction == 'new' ? true : false">
          <addresses v-loading="formLoading" parent="courses" :parentId="id" ref="addresses"></addresses>
        </el-tab-pane>
      </el-tabs>
    </card>
  </div>
