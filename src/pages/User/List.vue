    ...
    <div class="list-header">
      ...
      <div class="filters">
        <el-select
          ...
          :placeholder="$t('pages.faqs.perpage-placeholder')"
          v-if="!loading"
        >
          <el-option
      ...
      <table v-loading="loading">
        ...
        <tbody>
          <tr v-for="item in tableData" :key="item.id">
            ...
            <td class="actions">
              <button type="button" title="Inativar" class="bt">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle opacity="0.7" cx="12" cy="12" r="12" fill="#13BF30"/>
              ...
              <button type="button" title="Reenviar validação" class="bt">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button type="button" title="Editar" class="bt">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button type="button" title="apagar" class="bt">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
