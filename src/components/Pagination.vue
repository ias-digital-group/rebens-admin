<template>
    <div class="pagination">
        <div class="box-qty">
            <a class="bt bt-square" :class="{'bg-light-blue c-white': perPage === 5, 'bg-light-gray': perPage !== 5}">05</a>
            <a class="bt bt-square" :class="{'bg-light-blue c-white': perPage === 10, 'bg-light-gray': perPage !== 10}">10</a>
            <a class="bt bt-square" :class="{'bg-light-blue c-white': perPage === 25, 'bg-light-gray': perPage !== 25}">25</a>
            <a class="bt bt-square" :class="{'bg-light-blue c-white': perPage === 50, 'bg-light-gray': perPage !== 50}">50</a>
        </div>
        <ul class="box-pag">
