<template>
    <div>
        <div class="box-qty">
            <a @click="perPageChange(5)" class="bt bt-square" :class="{'bg-light-blue c-white': perPage === 5, 'bg-light-gray': perPage !== 5}">05</a>
            <a @click="perPageChange(10)" class="bt bt-square" :class="{'bg-light-blue c-white': perPage === 10, 'bg-light-gray': perPage !== 10}">10</a>
            <a @click="perPageChange(25)" class="bt bt-square" :class="{'bg-light-blue c-white': perPage === 25, 'bg-light-gray': perPage !== 25}">25</a>
            <a @click="perPageChange(50)" class="bt bt-square" :class="{'bg-light-blue c-white': perPage === 50, 'bg-light-gray': perPage !== 50}">50</a>
        </div>
        <div class="box-right">
          <ul class="box-pag">
...
export default {
  ...
  methods: {
    ...
    goToPage() {
      if(this.currentPage !== this.value 
        && this.currentPage > 0 
